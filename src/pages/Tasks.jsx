                ...
                <tbody>
                  {tasks?.map((task, index) => (
                    ...
                    >
                      ...
                      <td className="pl-4">
                        <button onClick={() => makediv(task)} className="focus:ring-2 focus:ring-offset-2 focus:ring-red-300 text-sm leading-none text-gray-600 py-3 px-5 bg-gray-100 rounded hover:bg-gray-200 focus:outline-none">
                          View
                        </button>
                      </td>
          ...
          <div className="relative overflow-x-auto w-full shadow-md sm:rounded-lg">
            <table className="w-full text-sm text-left rtl:text-right text-white">
              ...
              <tr key={uuidv4()} className="w-full border-b">
                            ...
                            </tr> <tr key={uuidv4()} className="w-full border-b">
                              <th scope="row" className="px-6 py-4 font-medium text-white">
                              created_at:
                              </th>
